...
const Head = ({ metadata }) => (
  <Helmet>
    ...
    <link rel="canonical" href="https://danielhuynh.co" />
    ...
    <meta name="msapplication-TileColor" content={config.colors.tiffanyWhite} />
    <meta name="msapplication-TileImage" content={msIcon144x144} />
    <meta name="theme-color" content={config.colors.white} />
  </Helmet>
);
